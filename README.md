...
## v7 — Безпечне видалення клієнта
- Кнопка видалення доступна лише для клієнтів у «Архіві».
- Перед видаленням потрібно вручну ввести назву клієнта.
- Видаляється картка клієнта, історія оплат і пов'язані логи нагадувань через каскадні зв'язки Supabase.
- Для v7 нова SQL-міграція не потрібна.
