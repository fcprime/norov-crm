...
function App() {
  ...
  const filteredClients = useMemo(()=>clients.filter(c=>(clientFilter==='all'||c.status===clientFilter) && [c.name,c.service,c.source,c.contact].join(' ').toLowerCase().includes(query.toLowerCase())),[clients,clientFilter,query]);
